...
\lstinputlisting[language=PHP, caption={Šablona hlavièky zásuvného modulu systému WordPress. \citep{wp-pluginhowto}}, label=lst:wp-plugin-header]{listings/wp-plugin-header.php}
